...
async fn read_value(fetch_upfront: bool) -> anyhow::Result<()> {
    ...
    // let node_id = ua::NodeId::from_str("ns=3;s=\"6601_HMI\".\"B201\"").unwrap();

    // client.add_data_types(&[
    //     ua::DataTypeDescription::Structure(ua::StructureDescription::foo(3003)),
    //     ua::DataTypeDescription::Structure(ua::StructureDescription::foo(3006)),
    //     ua::DataTypeDescription::Structure(ua::StructureDescription::foo(3011)),
    // ])?;
