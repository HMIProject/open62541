...
use super::node_id::{NodeIdWithDataEncodingFlags, read_node_id_with_data_encoding_flags};
...
impl BinaryReader for ExpandedNodeId {
    fn read(data: &mut bytes::Bytes) -> Self {
        ...
        let namespace_uri = has_namespace_uri
            .then(|| String::read(data))
            .unwrap_or_else(String::null);
        let server_index = has_server_index
