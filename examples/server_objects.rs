...
fn addPumpObjectInstace(server: &Server, name: &str, pump_type_id: &NodeId) {
...
fn pumpTypeConstructor(
    ...
    rpe.init()
        .referenceTypeId(NodeId::numeric(0, UA_NS0ID_HASCOMPONENT))
        .is_inverse(false)
        .include_subtypes(false)
        .target_name(1, "Status");
}
...
fn main() -> anyhow::Result<()> {
    ...
    addPumpObjectInstace(&server, "pump2", &pump_type_id);
